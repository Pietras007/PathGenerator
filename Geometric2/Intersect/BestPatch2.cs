...
{
    public class BestPatch2 : ISurface
    {
        ...
        public BestPatch2(ModelGeneration.BezierPatchC0 _patchC0)
        {
        ...
        public BestPatch2(ModelGeneration.BezierPatchC0 _patchC0, int patchNo, bool reversed = false)
        {
            splitA = _patchC0.splitB;
            splitB = _patchC0.splitA;
            patchesAll = new Patch[splitA, splitB];
