...
namespace SharpSceneSerializer
{
    public static class SceneSerializer
    {
        ...
        public static (bool succeded, Scene scene) Deserialize(string filePath, string schemaPath)
        {
            ...
            Newtonsoft.Json.Schema.JSchema schema = Newtonsoft.Json.Schema.JSchema.Parse(jsonSchemaContent);
            Newtonsoft.Json.Linq.JObject jsonObject = Newtonsoft.Json.Linq.JObject.Parse(jsonFileContent);
